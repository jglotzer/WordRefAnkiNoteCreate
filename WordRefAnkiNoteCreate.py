...
# Requires and inspired by wordreference python module
...
def send_json_request(requestJsonString):
    ...
    try:
        ...
        print("URLLib error. Check Anki is running, AnkiConnect is installed.")
...
#   article          optional article (e.g. le, la, un, une) not used in lookup
#                     but used to create card
